          ...
          <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card lol-window">
              ...
              <div class="card-footer text-muted text-center">
                created by
                <router-link :to="{name: 'contact'}">trippysalmon</router-link> / {{ version }} / blockdata kindly provided by
...
export default {
  ...
  methods: {
    refresh() {
      this.$store.dispatch('reload_data')
    },
    notify(t) {
      this.$notify({
        title: t,
  ...
  watch: {
    ...
    btc_h(n, o) {
      ...
      setTimeout(() => { this.left = false }, 100)
    },
    bch_h(n, o) {
      if (o == 0) return
    ...
    visible(n, o) {
      if (n === true) {
        this.refresh()
        this.$store.dispatch('poll_data')
        setTimeout(() => { this.left = false }, 5000)
      } else {
